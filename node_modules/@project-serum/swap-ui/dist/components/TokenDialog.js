...
function TokenDialog(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.Dialog, __assign({ open: open, onClose: onClose, scroll: "paper", PaperProps: {
        ...
        } }, { children: [(0, jsx_runtime_1.jsxs)(core_1.DialogTitle, __assign({ style: { fontWeight: "bold" } }, { children: [(0, jsx_runtime_1.jsx)(core_1.Typography, __assign({ variant: "h6", style: { paddingBottom: "16px" } }, { children: "Select a token" }), void 0), (0, jsx_runtime_1.jsx)(core_1.TextField, { className: styles.textField, placeholder: "Search name", value: tokenFilter, fullWidth: true, variant: "outlined", onChange: function (e) { return setTokenFilter(e.target.value); } }, void 0)] }), void 0), (0, jsx_runtime_1.jsx)(core_1.DialogContent, __assign({ className: styles.dialogContent, dividers: true }, { children: (0, jsx_runtime_1.jsx)(core_1.List, __assign({ disablePadding: true }, { children: tokens.map(function (tokenInfo) { return ((0, jsx_runtime_1.jsx)(TokenListItem, { tokenInfo: tokenInfo, onClick: function (mint) {
                            setMint(mint);
                            onClose();
                        } }, tokenInfo.address)); }) }), void 0) }), void 0), displayTabs && ((0, jsx_runtime_1.jsx)(core_1.DialogActions, { children: (0, jsx_runtime_1.jsxs)(core_1.Tabs, __assign({ value: tabSelection, onChange: function (e, v) { return setTabSelection(v); }, classes: {
                        indicator: styles.tabIndicator,
                    } }, { children: [(0, jsx_runtime_1.jsx)(core_1.Tab, { value: 0, className: styles.tab, classes: { selected: styles.tabSelected }, label: "Main" }, void 0), (0, jsx_runtime_1.jsx)(core_1.Tab, { value: 1, className: styles.tab, classes: { selected: styles.tabSelected }, label: "Wormhole" }, void 0), (0, jsx_runtime_1.jsx)(core_1.Tab, { value: 2, className: styles.tab, classes: { selected: styles.tabSelected }, label: "Sollet" }, void 0)] }), void 0) }, void 0))] }), void 0));
}
...
function TokenListItem(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(core_1.ListItem, __assign({ button: true, onClick: function () { return onClick(mint); }, style: { padding: "10px 20px" } }, { children: [(0, jsx_runtime_1.jsx)(Swap_1.TokenIcon, { mint: mint, style: { width: "30px", borderRadius: "15px" } }, void 0), (0, jsx_runtime_1.jsx)(TokenName, { tokenInfo: tokenInfo }, void 0)] }), void 0));
}
function TokenName(_a) {
    var tokenInfo = _a.tokenInfo;
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ style: { marginLeft: "16px" } }, { children: [(0, jsx_runtime_1.jsx)(core_1.Typography, __assign({ style: { fontWeight: "bold" } }, { children: tokenInfo === null || tokenInfo === void 0 ? void 0 : tokenInfo.symbol }), void 0), (0, jsx_runtime_1.jsx)(core_1.Typography, __assign({ color: "textSecondary", style: { fontSize: "14px" } }, { children: tokenInfo === null || tokenInfo === void 0 ? void 0 : tokenInfo.name }), void 0)] }), void 0));
}
